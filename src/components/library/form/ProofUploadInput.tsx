...
const ProofUploadInput = ({ prev, next }: Props) => {
  return (
    <Flex
      w="100%"
      maxW="100%"
    ...
    >
      ...
      >
        <VStack w="100%" align="start">
          ...
          >
            <Text color="gray.700"> Haa fine, now please </Text>
            <Heading fontSize={{ base: "2xl", md: "3xl" }}>
              <strong>Upload the proofs</strong>
            </Heading>
          </VStack>
          ...
          <Text
            ...
            color="gray.700"
          >
            You will never share your details with anyone{`:)`}
          </Text>
        </VStack>
